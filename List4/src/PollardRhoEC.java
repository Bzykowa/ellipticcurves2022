...
public class PollardRhoEC {
     ...
     */
    public PollardRhoEC(EllipticCurve curve, Point bigY) {
        this.curve = curve;
        this.bigY = bigY;
    }
    ...
    private int partition(Point r) {
        ...
        if (r.y.compareTo(partitionPoint) == -1) {
            return 0;
        } else if (r.y.compareTo(partitionPoint.multiply(BigInteger.TWO)) == -1) {
            return 1;
        } else {
            return 2;
        }
